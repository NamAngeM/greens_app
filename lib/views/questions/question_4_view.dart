...
class Question4View extends StatefulWidget {
  ...
  @override
  State<Question4View> createState() => _Question4ViewState();
}

class _Question4ViewState extends State<Question4View> {
  String? _selectedOption;
  final double _progressValue = 0.8; // 4/5 questions
  ...
  void _selectOption(String option) {
    ...
    Navigator.pushNamed(context, AppRoutes.question5);
  }

  void _saveAnswer(String answer) async {
    // Enregistrer la réponse dans SharedPreferences
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('question4_answer', answer);
    
    // Utiliser un print pour le débogage
    print('Réponse à la question 4: $answer');
  }
