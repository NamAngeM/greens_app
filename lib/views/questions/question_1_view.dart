...
class Question1View extends StatefulWidget {
  ...
  @override
  State<Question1View> createState() => _Question1ViewState();
}

class _Question1ViewState extends State<Question1View> {
  String? _selectedOption;
  final double _progressValue = 0.2; // 1/5 questions

  final List<String> _options = [
    'Pour des conseils pratiques et faciles',
    'Par curiosité',
    'Pour améliorer mes connaissances',
    'Pour commencer un voyage zéro déchet',
    'Autre'
  ];
  ...
  void _selectOption(String option) {
    ...
    Navigator.pushNamed(context, AppRoutes.question2);
  }

  void _saveAnswer(String answer) async {
    // Sauvegarder la réponse dans les SharedPreferences pour référence future
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('question1_answer', answer);
    
    // Utiliser un print pour le débogage
    print('Réponse à la question 1: $answer');
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Question principale
              Text(
                'Pourquoi avez-vous téléchargé GreenMinds ?',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 28,
